...
namespace Angular_ASPNETCore_CustomersService.Apis
{
    ...
    public class CustomersApiController : Controller
    {
        ...
        [HttpGet]
        [NoCache]
        [ProducesResponseType(typeof(List<Entries>), 200)]
        ...
        [NoCache]
        [ProducesResponseType(typeof(Entries), 200)]
        [ProducesResponseType(typeof(ApiResponse), 400)]
        ...
        [ProducesResponseType(typeof(ApiResponse), 400)]
        public async Task<ActionResult> CreateCustomer([FromBody]Entries customer)
        {
        ...
        [ProducesResponseType(typeof(ApiResponse), 400)]
        public async Task<ActionResult> UpdateCustomer(int id, [FromBody]Entries customer)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(new ApiResponse { Status = false, ModelState = ModelState });
